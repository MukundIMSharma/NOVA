...
# from dotenv import dotenv_values  -- TO FETCH DATA FROM ENV FILE
# env_vars = dotenv_values(".env")
# CohereAPIKey = env_vars["COHERE_API_KEY"]
CohereAPIKey = "twkLh57xsxWOQ48urGf1unF4AW2g2ei9tvNVYoav"

co = cohere.Client(CohereAPIKey)  # Initialize the Cohere client with your API key
...
def FirstLayerDMM(prompt: str = 'test'):
    ...
    response = [i.strip() for i in response]  # Clean up the response by stripping whitespace.
